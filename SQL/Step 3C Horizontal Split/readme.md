...
Technically this is done by creating a table containing the larger columns, keeping as many as possible of the smaller columns in the other table. 
...
If we previously have denormalized the tables vertically, we must perform the horizontal denormalization on both tables. Therefore we also create a PAIDInvoicerowomment table.
